...
import { forgotPasswordStyles as s } from "../assets/dummyStyles.jsx";
...
const ForgotPasswordPage = () => {
  ...
  const sendCode = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || "Could not send the code");
    } finally {
      setBusy(false);
    }
  };
              ...
              {pw2 && (
                <span
                  className={`${s.confirmFeedback} ${
                    pw2 === pw
                      ? s.confirmFeedbackValid
                      : s.confirmFeedbackInvalid
                  }`}
                >
                  {pw2 === pw ? "✓" : "✗"}
                </span>
